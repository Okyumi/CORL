...
from scipy.spatial import KDTree  # Add this line
...
class TrainConfig:
    # Experiment
    # yd2247
    reward_approach: str = "original"  # Options: original, naive, difference
    expert_pct: float = 1.0  # Top % of trajectories to use as expert
